        ...
        try (Connection con = GirlkunDB.getConnection();) {
            ...
            for(ItemKyGui it : this.listItem){
                ...
                s.execute(String.format(
                        "INSERT INTO `shop_ky_gui`(`id`, `player_id`, `tab`, `item_id`, `gold`, `ruby`, `quantity`, `itemOption`, `isUpTop`, `isBuy`) VALUES ('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')",
                        it.id, it.player_sell, it.tab, it.itemId, it.goldSell, it.rubySell, it.quantity,
