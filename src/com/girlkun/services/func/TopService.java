...
//
//    private static final int TIME_TARGET_GET_TOP_POWER = 900000;
//
//    private static TopService i;
//
...
//    
//    private long lastTimeGetTopNap;
//    private List<Player> listTopNap;
//    
//    private TopService() {
//        this.listTopPower = new ArrayList<>();
//        this.listTopNap = new ArrayList<>();
//    }
//
//    public static TopService gI() {
//        if (i == null) {
...
//            this.listTopPower = PlayerDAO.getPlayersTop();
//        }
//        Message msg;
//        try {
//            msg = new Message(-96);
...
//        if (Util.canDoWithTime(lastTimeGetTopNap, TIME_TARGET_GET_TOP_POWER)) {
//            this.lastTimeGetTopNap = System.currentTimeMillis();
//            this.listTopNap.clear();
//            this.listTopNap = PlayerDAO.getPlayersNap();
//        }
//        Message msg;
//        try {
//            msg = new Message(-96);
//            msg.writer().writeByte(0);
//            msg.writer().writeUTF("Top Nap");
//            msg.writer().writeByte(this.listTopNap.size());
//            for (int i = 0; i < this.listTopNap.size(); i++) {
//                Player pl = this.listTopNap.get(i);
//                msg.writer().writeInt(i+1);
//                msg.writer().writeInt((int) pl.id);
//                msg.writer().writeShort(pl.getHead());
//                msg.writer().writeShort(-1);
