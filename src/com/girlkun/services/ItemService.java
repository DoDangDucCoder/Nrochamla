...
public class ItemService {
    ...
    public void openHopQuaMayMan(Player player, Item itemUse) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(player) < 1) {
                Service.getInstance().sendThongBao(player, "Bạn phải có ít nhất 1 ô trống hành trang");
                return;
            }
            List<Integer> listQua = Arrays.asList(1107, 909, 936, 1046, 919);
            Collections.shuffle(listQua);
            int randomElement = listQua.get(0);
            Item item = createNewItem((short) randomElement);
...
//            item.itemOptions.add(new Item.ItemOption(5, 40)); // sức đánh chí mạng
            if (Util.isTrue(50, 100)) {
                item.itemOptions.add(new Item.ItemOption(93, Util.nextInt(1, 3))); // hsd
            }
    ...
    public void halloween(Player player, Item itemUse) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(player) < 1) {
                Service.getInstance().sendThongBao(player, "Bạn phải có ít nhất 1 ô trống hành trang");
                return;
            }
            List<Integer> listQua = Arrays.asList(1200, 1201, 2070,
2071,
2072,
2073,
2074,
...
2084,1207);
            ...
            int randomElement = listQua.get(0);
            Item item = createNewItem((short) randomElement);
            item.itemOptions.add(new Item.ItemOption(50, Util.nextInt(15, 25))); // hsd
            item.itemOptions.add(new Item.ItemOption(77, Util.nextInt(15, 25))); // hsd
            item.itemOptions.add(new Item.ItemOption(103,Util.nextInt(15, 25))); // hsd
            item.itemOptions.add(new Item.ItemOption(5, Util.nextInt(5, 20))); // hsdchí mạng
            if (Util.isTrue(50, 100)) {
                item.itemOptions.add(new Item.ItemOption(93, Util.nextInt(1, 3))); // hsd
            }
            InventoryServiceNew.gI().subQuantityItemsBag(player, itemUse, 1);
 ...
 public void openhalloween(Player player, Item itemUse) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(player) < 1) {
                Service.getInstance().sendThongBao(player, "Bạn phải có ít nhất 1 ô trống hành trang");
                return;
            }
            List<Integer> listQua = Arrays.asList(814, 817, 815, 816, 741, 743);
            Collections.shuffle(listQua);
            int randomElement = listQua.get(0);
            Item item = createNewItem((short) randomElement);
            item.itemOptions.add(new Item.ItemOption(50, Util.nextInt(5, 15))); // hsd
            item.itemOptions.add(new Item.ItemOption(77, Util.nextInt(5, 15))); // hsd
            item.itemOptions.add(new Item.ItemOption(103, Util.nextInt(5, 15))); // hsd
            item.itemOptions.add(new Item.ItemOption(87, 0)); 
            item.itemOptions.add(new Item.ItemOption(30, 0)); // sức đánh chí mạng
            if (Util.isTrue(85, 100)) {
                item.itemOptions.add(new Item.ItemOption(93, Util.nextInt(1, 5))); // hsd
            }
            InventoryServiceNew.gI().subQuantityItemsBag(player, itemUse, 1);
            InventoryServiceNew.gI().addItemBag(player, item);
            InventoryServiceNew.gI().sendItemBags(player);
 ...
 public void champa(Player player, Item itemUse) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(player) < 1) {
                Service.getInstance().sendThongBao(player, "Bạn phải có ít nhất 1 ô trống hành trang");
                return;
            }
            List<Integer> listQua = Arrays.asList(1242);
            Collections.shuffle(listQua);
            int randomElement = listQua.get(0);
            Item item = createNewItem((short) randomElement);
            item.itemOptions.add(new Item.ItemOption(50, Util.nextInt(25, 30))); // hsd
            item.itemOptions.add(new Item.ItemOption(77, Util.nextInt(25, 30))); // hsd
            item.itemOptions.add(new Item.ItemOption(103, Util.nextInt(25, 30))); // hsd
            item.itemOptions.add(new Item.ItemOption(5, 20)); 
            item.itemOptions.add(new Item.ItemOption(30, 0)); // sức đánh chí mạng
            if (Util.isTrue(99, 100)) {
                item.itemOptions.add(new Item.ItemOption(93, Util.nextInt(1, 2))); // hsd
            }
            InventoryServiceNew.gI().subQuantityItemsBag(player, itemUse, 1);
            InventoryServiceNew.gI().addItemBag(player, item);
            InventoryServiceNew.gI().sendItemBags(player);
    ...
    public void openHopQuaMay(Player player, Item itemUse) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(player) < 1) {
                Service.getInstance().sendThongBao(player, "Bạn phải có ít nhất 1 ô trống hành trang");
                return;
            }
            List<Integer> listQua = Arrays.asList(1187);
            Collections.shuffle(listQua);
            int randomElement = listQua.get(0);
            Item item = createNewItem((short) randomElement);
...
//            item.itemOptions.add(new Item.ItemOption(5, 40)); // sức đánh chí mạng
    ...
    public void openHopQuaCayChay(Player player, Item itemUse) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(player) < 1) {
                Service.getInstance().sendThongBao(player, "Bạn phải có ít nhất 1 ô trống hành trang");
                return;
            }
            List<Integer> listQua = Arrays.asList(2042, 2043, 2034, 2035, 2034);
            Collections.shuffle(listQua);
            int randomElement = listQua.get(0);
            Item item = createNewItem((short) randomElement);
            ...
            if (Util.isTrue(90, 100)) {
                item.itemOptions.add(new Item.ItemOption(93, Util.nextInt(1, 10))); // hsd
            }
            InventoryServiceNew.gI().subQuantityItemsBag(player, itemUse, 1);
            InventoryServiceNew.gI().addItemBag(player, item);
            InventoryServiceNew.gI().sendItemBags(player);
    ...
    public void openHopQuaDanChoi(Player player, Item itemUse) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(player) < 1) {
                Service.getInstance().sendThongBao(player, "Bạn phải có ít nhất 1 ô trống hành trang");
                return;
            }
            List<Integer> listQua = Arrays.asList(1123, 1124, 1125, 1117, 1113, 1114, 1115, 1116);
            Collections.shuffle(listQua);
            int randomElement = listQua.get(0);
            Item item = createNewItem((short) randomElement);
            item.itemOptions.add(new Item.ItemOption(50, Util.nextInt(3, 10)));
            item.itemOptions.add(new Item.ItemOption(48, Util.nextInt(3, 10)));
//            item.itemOptions.add(new Item.ItemOption(5, Util.nextInt(5, 15))); // sức đánh chí mạng
            if (Util.isTrue(80, 100)) {
                item.itemOptions.add(new Item.ItemOption(93, Util.nextInt(1, 7))); // hsd
            }
            InventoryServiceNew.gI().subQuantityItemsBag(player, itemUse, 1);
            InventoryServiceNew.gI().addItemBag(player, item);
            InventoryServiceNew.gI().sendItemBags(player);
    ...
    public void openHopQuaCayChayPet(Player player, Item itemUse) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(player) < 1) {
                Service.getInstance().sendThongBao(player, "Bạn phải có ít nhất 1 ô trống hành trang");
                return;
...
//            item.itemOptions.add(new Item.ItemOption(5, 15)); // sức đánh chí mạng
            if (Util.isTrue(90, 100)) {
                item.itemOptions.add(new Item.ItemOption(93, Util.nextInt(1, 10))); // hsd
            }
            InventoryServiceNew.gI().subQuantityItemsBag(player, itemUse, 1);
    ...
    public void openHopQuaMocNap(Player player, Item itemUse) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(player) <= 1) {
            ...
            if (rd <= dbv) {
             item = daBaoVe();
                ...
                item = vanBay1144(true);
            } else if (rd <= dbv + vb + kt) {
                item = phuKien1141(true);
            } else if (rd <= dbv + vb + ct +kt) {
                item = caitrang1133(true);  
            }
    ...
    public void openHopQuaHeVIP(Player player, Item itemUse) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(player) <= 1) {
                Service.getInstance().sendThongBao(player, "Bạn phải có ít nhất 2 ô trống hành trang");
                return;
            ...
            if (rd <= dbv) {
             item = daBaoVe();
                ...
                item = vanBay1157(true);
            } else if (rd <= dbv + vb + kt) {
                item = phuKien1180(true);
            } else if (rd <= dbv + vb + ct +kt) {
                item = caitrang1152(true);
            } else if (rd <= dbv + vb + ct + kt + ct1) {
                item = caitrang1151(true);    
            }
            if (item.template.id == 861) {
                item.quantity = Util.nextInt(1, 10);
            }
    ...
    public void HOPQUALINHTU(Player player, Item itemUse) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(player) < 1) {
                Service.getInstance().sendThongBao(player, "Bạn phải có ít nhất 1 ô trống hành trang");
                return;
            }
            List<Integer> listQua = Arrays.asList(2019, 2020, 2021, 2022, 2023, 2024, 2025, 2026);
            Collections.shuffle(listQua);
            int randomElement = listQua.get(0);
            Item item = createNewItem((short) randomElement);
            item.itemOptions.add(new Item.ItemOption(50, 10));
            item.itemOptions.add(new Item.ItemOption(77, 10));
            item.itemOptions.add(new Item.ItemOption(103, 10));
            item.itemOptions.add(new Item.ItemOption(5, 5)); // sức đánh chí mạng
            if (Util.isTrue(0, 100)) {
                item.itemOptions.add(new Item.ItemOption(30, Util.nextInt(1, 10))); // hsd
            }
            InventoryServiceNew.gI().subQuantityItemsBag(player, itemUse, 1);
            InventoryServiceNew.gI().addItemBag(player, item);
            InventoryServiceNew.gI().sendItemBags(player);
    ...
    public void HOPQUAPET(Player player, Item itemUse) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(player) < 1) {
                Service.getInstance().sendThongBao(player, "Bạn phải có ít nhất 1 ô trống hành trang");
                return;
            }
            List<Integer> listQua = Arrays.asList(1145,1148,1039,1040,892,893);
            Collections.shuffle(listQua);
            int randomElement = listQua.get(0);
            Item item = createNewItem((short) randomElement);
            ...
            item.itemOptions.add(new Item.ItemOption(5, 1)); // sức đánh chí mạng
            if (Util.isTrue(0, 100)) {
                item.itemOptions.add(new Item.ItemOption(30, Util.nextInt(1, 10))); // hsd
            }
            InventoryServiceNew.gI().subQuantityItemsBag(player, itemUse, 1);
    ...
    public void OpenDoTs(Player player, int gender, int itemtype) {

        int[][] items = {{1048, 1051, 1054, 1057, 1060}, {1049, 1052, 1055, 1058, 1060}, {1050, 1053, 1056, 1059, 1060}}; //td, namec,xd
        Item item = randomCS_TS(items[player.gender][itemtype], gender);
    ...
    public Item randomCS_TS(int itemId, int gender) {
        Item it = createItemSetKichHoat(itemId, 1);
        ...
        if (quan.contains(itemId)) {
            it.itemOptions.add(new Item.ItemOption(22, Util.highlightsItem(gender == 0, new Random().nextInt(100) + 200))); // hp 85-100k
        }
        if (gang.contains(itemId)) {
            it.itemOptions.add(new Item.ItemOption(0, Util.highlightsItem(gender == 2, new Random().nextInt(4000) + 18000))); // 8500-10000
        }
        if (giay.contains(itemId)) {
            it.itemOptions.add(new Item.ItemOption(23, Util.highlightsItem(gender == 1, new Random().nextInt(100) + 200))); // ki 80-90k
        }
        if (nhd == itemId) {
            it.itemOptions.add(new Item.ItemOption(14, new Random().nextInt(5) + 21)); //chí mạng 17-19%
        }
        it.itemOptions.add(new Item.ItemOption(21, 120));// yêu cầu sm 80 tỉ
        it.itemOptions.add(new Item.ItemOption(30, 1));// ko the gd
        return it;
    }
    ...
    public Item caitrang1152(boolean rating) {
        Item item = createItemSetKichHoat(1152, 1);
        item.itemOptions.add(new Item.ItemOption(50, new Random().nextInt(15) + 35));
        item.itemOptions.add(new Item.ItemOption(48, new Random().nextInt(15) + 30));
        item.itemOptions.add(new Item.ItemOption(14, new Random().nextInt(9) + 1));
     ...
     public Item caitrang1151(boolean rating) {
        Item item = createItemSetKichHoat(1151, 1);
        item.itemOptions.add(new Item.ItemOption(50, new Random().nextInt(15) + 35));
        item.itemOptions.add(new Item.ItemOption(48, new Random().nextInt(15) + 30));
        item.itemOptions.add(new Item.ItemOption(14, new Random().nextInt(9) + 1));
        if (Util.isTrue(1, 100)) {
        ...
        item.itemOptions.add(new Item.ItemOption(30, 1));//ko the gd
        if (Util.isTrue(900, 1000) && rating) {// tỉ lệ ra hsd
            item.itemOptions.add(new Item.ItemOption(93, new Random().nextInt(3) + 1));//hsd
        }
        return item;
    }
      public Item caitrang1150(boolean rating) {
        Item item = createItemSetKichHoat(1150, 1);
     ...
     public Item caitrang1133(boolean rating) {
        Item item = createItemSetKichHoat(1133, 1);
        item.itemOptions.add(new Item.ItemOption(50, new Random().nextInt(15) + 35));
        item.itemOptions.add(new Item.ItemOption(48, new Random().nextInt(15) + 30));
        item.itemOptions.add(new Item.ItemOption(14, new Random().nextInt(9) + 1));
        if (Util.isTrue(1, 100)) {
    ...
    public Item phuKien1180(boolean rating) {
        Item item = createItemSetKichHoat(1180, 1);
        item.itemOptions.add(new Item.ItemOption(50, new Random().nextInt(15) + 35));
        item.itemOptions.add(new Item.ItemOption(48, new Random().nextInt(15) + 30));
        item.itemOptions.add(new Item.ItemOption(5, new Random().nextInt(20) + 5));
        if (Util.isTrue(1, 100)) {
            item.itemOptions.get(Util.nextInt(item.itemOptions.size() - 1)).param = 10;
        }
        item.itemOptions.add(new Item.ItemOption(30, 1));//ko the gd
    ...
    public Item phuKien1141(boolean rating) {
        Item item = createItemSetKichHoat(1141, 1);
        item.itemOptions.add(new Item.ItemOption(50, new Random().nextInt(15) + 35));
        item.itemOptions.add(new Item.ItemOption(48, new Random().nextInt(15) + 30));
        item.itemOptions.add(new Item.ItemOption(5, new Random().nextInt(20) + 5));
        if (Util.isTrue(1, 100)) {
    ...
    public Item vanBay1157(boolean rating) {
        Item item = createItemSetKichHoat(1157, 1);
        item.itemOptions.add(new Item.ItemOption(89, 1));
        item.itemOptions.add(new Item.ItemOption(30, 1));//ko the gd
    ...
    public Item vanBay1144(boolean rating) {
        Item item = createItemSetKichHoat(1144, 1);
        item.itemOptions.add(new Item.ItemOption(50, new Random().nextInt(10) + 10));
        item.itemOptions.add(new Item.ItemOption(48, new Random().nextInt(10) + 10));
        if (Util.isTrue(700, 1000) && rating) {// tỉ lệ ra hsd
            item.itemOptions.add(new Item.ItemOption(93, new Random().nextInt(3) + 1));//hsd
        }
        return item;
    ...
    public Item vanBay1156(boolean rating) {
        Item item = createItemSetKichHoat(1156, 1);
        item.itemOptions.add(new Item.ItemOption(89, 1));
        item.itemOptions.add(new Item.ItemOption(30, 1));//ko the gd
        if (Util.isTrue(700, 1000) && rating) {// tỉ lệ ra hsd
            item.itemOptions.add(new Item.ItemOption(93, new Random().nextInt(3) + 1));//hsd
