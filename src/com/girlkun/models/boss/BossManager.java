...
import com.girlkun.models.boss.list_boss.HuyDiet.vegeta;
import com.girlkun.models.boss.list_boss.HuyDiet.picolo;
import com.girlkun.models.boss.list_boss.HangBang.Frost;
import com.girlkun.models.boss.list_boss.pika;
import com.girlkun.models.boss.list_boss.bulma;
import com.girlkun.models.boss.list_boss.hit;
import com.girlkun.models.boss.list_boss.robot;
...
import com.girlkun.models.boss.list_boss.huydiett;
import com.girlkun.models.boss.list_boss.kysinhtrung;
import com.girlkun.models.boss.list_boss.huydiett1;
import com.girlkun.models.boss.list_boss.huydiett11;
import com.girlkun.models.boss.list_boss.halloween1;
import com.girlkun.models.boss.list_boss.halloween;
import com.girlkun.models.boss.list_boss.JackiChun;
...
public class BossManager implements Runnable {
    ...
    public void loadBoss() {
        ...
        try {
            this.createBoss(BossID.xen);
            this.createBoss(BossID.minuong);
            ...
            this.createBoss(BossID.KST);
            this.createBoss(BossID.KST);
            this.createBoss(BossID.KST);
            this.createBoss(BossID.HUYDIET);
            this.createBoss(BossID.HUYDIETT);
            this.createBoss(BossID.HUYDIET);
            this.createBoss(BossID.HUYDIETT);
            this.createBoss(BossID.HUYDIETTT);
            this.createBoss(BossID.HUYDIETTT);
            this.createBoss(BossID.XUONGKHO);
            this.createBoss(BossID.XUONGKHOO);
            this.createBoss(BossID.XUONGKHO);
            this.createBoss(BossID.XUONGKHOO);
            this.createBoss(BossID.XUONGKHO);
            this.createBoss(BossID.XUONGKHOO);
            this.createBoss(BossID.BULMAA);
            this.createBoss(BossID.PIKAA);
            this.createBoss(BossID.HIT);
            this.createBoss(BossID.ROBOT);
            this.createBoss(BossID.PIKAA);
            this.createBoss(BossID.PIKAA);
            this.createBoss(BossID.PIKAA);
            this.createBoss(BossID.PIKAA);
    ...
    public Boss createBoss(int bossID) {
        try {
            switch (bossID) {
                case BossID.JACKI_CHUN:
                    return new JackiChun();
                     case BossID.HUYDIET:
                    return new huydiett();
                    case BossID.HUYDIETT:
                    return new huydiett1();
                    case BossID.KST:
                    return new kysinhtrung();
                    case BossID.HUYDIETTT:
                    return new huydiett11();
//                     case BossID.XUONGKHO:
