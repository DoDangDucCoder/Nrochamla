...
public class BossID {
   ...
   public static final int HUYDIET = -509;
   public static final int KST = -513;
   public static final int HUYDIETT = -519;
   public static final int HUYDIETTT = -518;
   public static final int XUONGKHO = -520;
   public static final int XUONGKHOO = -517;
   public static final int PIKAA = -516;
 public static final int BULMAA = -522;
   public static final int POCC = -521;
   public static final int ROBOT = -528;
...
//   
    ...
    public static final int VEGETA_TS = -250;
    public static final int PICOLO_TS = -251;
