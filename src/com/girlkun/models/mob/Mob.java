...
//        nplayer
    ...
    public List<ItemMap> getItemMobReward(Player player, int x, int yEnd) {
        ...
        if (player.itemTime.isUsedohn1 && Util.isTrue(100, 100) && this.tempId > 0 && this.tempId < 50) {
            list.add(new ItemMap(zone, 861, 1, x, player.location.y, player.id));
        }
        if (player.itemTime.isUsedothoivang && Util.isTrue(100, 100) && this.tempId > 0 && this.tempId < 50) {
            list.add(new ItemMap(zone, 457, 1, x, player.location.y, player.id));
        }
        if (player.itemTime.isUsedohn && Util.isTrue(1000, 1000) && this.tempId > 5 && this.tempId < 100) {
            list.add(new ItemMap(zone, 861, 2, x, player.location.y, player.id));
        }
