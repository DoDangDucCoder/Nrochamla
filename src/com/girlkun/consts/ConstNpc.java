...
public class ConstNpc {
    ...
    public static final byte BULMAA = 80;
    ...
    public static final byte TRUNG_THU = 41;
     public static final byte JIREN = 79;
    ...
    public static final byte HUNGVUONG = 52;
    ...
    public static final byte VEGETA = 75;
    ...
    public static final byte NPC70 =  70;
    public static final byte PIC2MAI =  76;
    public static final byte RONG_HUYDIET = 77;
    public static final byte THIENSU = 78;
    ...
    public static final int MENU_PHA_LE_HOA_TINH_AN = 528;
    public static final int MENU_PHA_LE_HOA_TRANG_BI = 500;
    public static final int MENU_PHA_LE_HOA_CAI_TRANG = 504;
    ...
    public static final int MENU_NANG_BONG_TAI = 526;
    public static final int MENU_MO_CHI_SO_BONG_TAI = 527;
    public static final int MENU_NANG_BONG_TAI2 = 528;
    public static final int MENU_MO_CHI_SO_BONG_TAI2 = 529;
    public static final int MENU_NANG_CAP_TS = 530;
    ...
    public static final int MENU_ADMIN_PHU = 601;
    ...
    public static final int DOI_HOA = 523;
    
    public static final int MENU_FIND_PLAYER_PHU = 602;
     public static final int DOI_CAPSULE = 524;
    ...
    public static final int MENU_OPTION_USE_ITEM2085 = 2085;
    public static final int MENU_OPTION_USE_ITEM2086 = 2086;
    public static final int MENU_OPTION_USE_ITEM2087 = 2087;
    public static final int ACTIVE_PLAYER = 530;
